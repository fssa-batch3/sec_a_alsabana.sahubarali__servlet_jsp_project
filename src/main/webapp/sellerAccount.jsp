...
<body>
   <%
	...
	<div class="container">
		...
		<form id="update-form" action="EditUserServlet?userId=<%= user.getUserId() %>"
			method="post">
			<div class="form-group">
				<label for="sellerName">Seller Name<span
					class="required">*</span>:
				</label> <input type="text" id="sellerName" value= <%=user.getUsername() %> name="sellerName" required
					placeholder="Enter seller name" />
			</div>
			<div class="form-group">
				<label for="sellerEmail">Email<span class="required">*</span>:
				</label> <input type="email" id="sellerEmail" name="sellerEmail" value= <%= user.getEmail() %> required
					placeholder="Enter email" />
			</div>
			<div class="form-group">
				<label for="sellerPhone">Phone Number<span
					class="required">*</span>:
				</label> <input type="text" id="sellerPhone" value=<%=user.getNumber() %> name="sellerPhone" required
