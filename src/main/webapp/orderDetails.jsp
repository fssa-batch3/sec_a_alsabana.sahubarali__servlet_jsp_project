	...
	<div class="container">
		...
		<form action="createOrderServlet" method="POST">
			...
			<div class="form-group" style="display: none;" >
					<label for="quantity">Quantity:</label> <input type="number" value=${sessionScope.product.productId}
						 min="1" name="productId"required />
				</div>
			
				<div class="form-group">
					<label for="quantity">Quantity:</label> <input type="number" value="1"
			...
			<div class="form-group">
				<label for="address">Address:</label> <input type="text"
					id="address" name="address" placeholder="Enter delivered address" required />
			</div>
			<div class="form-group">
				<label for="address">Pincode:</label> <input type="text"
					id="address" name="pincode" placeholder="Enter your pincode" required />
			</div>
			<div class="form-group">
			...
			<div class="form-group">
				<label for="zipcode">Mobile number:</label> <input type="text" placeholder="Enter your number"
			...
			<div id="card_detail">
				<div class="form-group">
					<label for="cardnumber">Credit Card Number:</label> <input
						type="text" id="cardnumber" placeholder="Enter your credit card number" name="cardnumber"  />
				</div>
				<div class="form-group">
					<label for="expiration">Expiration Date:</label> <input type="text"
						id="expiration" name="expiration"  placeholder="MM/YY"  />
				</div>
			</div>
