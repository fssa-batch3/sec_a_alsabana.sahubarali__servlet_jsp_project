			...
			<div class="first-container">
				<div class="personal-container">
					...
					<form class="form edit" id="proform">
						...
						</label> <label>Email: <input type="email" id="email"
							placeholder="alsabana@gmail.com">
						</label> <label>Number: <input type="text" id="phNo"
							placeholder="8090177736">

						</label> <label> password: <input type="password" id="pass">
						</label> <label> Address: <textarea type="text" id="country"></textarea>
						</label>
